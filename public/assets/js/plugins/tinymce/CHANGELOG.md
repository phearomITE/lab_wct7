...
- New `getTransparentElements` function added to `tinymce .Schema` to return a map object of transparent HTML elements. #TINY-9172
...
- Removed the `shortEnded` and `fixed` properties on `tinymce .Node` class. #TINY-8205
