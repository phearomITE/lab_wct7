...
(function () {
    ...
    var global$3 = tinymce.util.Tools.resolve('tinymce .DomParser');
    ...
    var global$2 = tinymce.util.Tools.resolve('tinymce .Node');

    var global$1 = tinymce.util.Tools.resolve('tinymce .Serializer');
    ...
    const embedPromise = (data, dataToHtml, handler) => {
      return new Promise((res, rej) => {
        const wrappedResolve = response => {
          ...
          return res({
            url: data.source,
            html: response  ? response  : dataToHtml(data)
          });
        };
