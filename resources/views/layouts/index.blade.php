...
<head>
  <title>{{ config('app.name', 'Mantis HTML Admin Template') }} | Mantis Bootstrap 5 Admin Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
      ...
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-md-9 col-xl-6">
          ...
          <div class="my-5 wow fadeInUp" data-wow-delay="0.6s">
            <a href="{{ url('elements/bc_alert') }}" class="btn btn-outline-primary me-2" target="_blank">Explore Components</a>
            <a href="{{ url('dashboard/index') }}" class="btn btn-primary" target="_blank"> <i
